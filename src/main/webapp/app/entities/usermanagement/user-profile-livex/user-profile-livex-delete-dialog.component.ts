...
@Component({
  selector: 'jhi-user-profile-livex-delete-dialog',
  templateUrl: './user-profile-livex-delete-dialog.component.html'
})
export class UserProfileLivexDeleteDialogComponent {
...
@Component({
  selector: 'jhi-user-profile-livex-delete-popup',
  template: ''
})
export class UserProfileLivexDeletePopupComponent implements OnInit, OnDestroy {
  ...
  ngOnInit() {
    this.activatedRoute.data.subscribe(({ userProfile }) => {
      setTimeout(() => {
        this.ngbModalRef = this.modalService.open(UserProfileLivexDeleteDialogComponent as Component, { size: 'lg', backdrop: 'static' });
